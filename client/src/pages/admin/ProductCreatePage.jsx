...
function ProductCreatePage() {
  ...
  useEffect(() => {
    ...
    if (!cloudName || !uploadPreset) {
      console.warn('Cloudinary 환경변수가 설정되지 않았습니다. .env 파일을 확인해주세요.');
      setError('Cloudinary 설정이 필요합니다. 관리자에게 문의하세요.');
      return;
    }
    ...
    if (window.cloudinary) {
      ...
      console.error('Cloudinary 위젯 스크립트가 로드되지 않았습니다.');
      setError('이미지 업로드 기능을 사용할 수 없습니다.');
    }
